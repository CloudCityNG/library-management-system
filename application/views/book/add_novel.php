...
<div class="row">
	<div class="col-sm-12">
		<h3 class="page-header" style="margin-top: 10px">Add Novel</h3>
		<div class="alert alert-dismissable alert-success">
			<?php
				if(isset($last_id)){
					foreach($last_id->result_array() as $fetchrow){
						echo "<b>".$fetchrow['novel_name']."</b> was given Novel ID <b>".$fetchrow['novel_id']."</b>";
					}
				}
			?>
		</div>
...
<div class="row">
	<div class="col-sm-2">
		<?php
			...
			echo br();
			echo form_label("<h5>Novel &nbsp;&nbsp;</h5>","type1");
